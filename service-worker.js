const CACHE_NAME='rindik-art-v6';
const ASSETS=['./','./index.html','./admin.html','./admin.css','./admin-fix.css','./admin.js','./supabase-config.js','./manifest.webmanifest','./rindik-art-logo.png','./rindik-art-icon.png'];
